...
public class Signup3 extends JFrame implements ActionListener{
    ...
    JLabel l1,account,card,Number,cardNumber,carddetail,pin,pinNumber,password,service,fnum,l12;
 ...
 //-------------------------------------------------------------------------------       
        ...
        Number = new JLabel("XXXX-XXXX-XXXX-6704");
  ...
  //---------------------------------------------------------------------------------      
        ...
        cardNumber.setBounds(100,330,200,20);
        add(cardNumber);
        
        carddetail = new JLabel("It would appear on ATM Card/Cheque Book and Statements");
        carddetail.setFont(new Font("Raleway", Font.BOLD, 12));
        carddetail.setBounds(330,330,500,20);
        add(carddetail);
...
//-------------------------------------------------------------------------------------        
        ...
        password.setBounds(100,400,200,20);
        add(password);
...
//---------------------------------------------------------------------------------------        
        ...
        fnum = new JLabel("Form No:");
        fnum.setFont(new Font("Raleway", Font.BOLD, 14));
        fnum.setBounds(700,10,70,30);
        add(fnum);
